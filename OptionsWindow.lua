...
function GenerateOptionsWindowTokens()
		...
		OptionsWindowTokens.Message=Turbine.UI.Label(); 
			...
			OptionsWindowTokens.Message:SetTextAlignment(Turbine.UI.ContentAlignment.MiddleCenter); 
			OptionsWindowTokens.Message:SetFont(Turbine.UI.Lotro.Font.Verdana16);
			...
			-- first tokens -- Piece
			-------------------------------------------------------------------
			TitleDisplayer(OptionsWindowTokens, posx, posy, T[ "TokenContent1" ], colorUsedFortexte, colorUsedForLines, 300);
			...
			for i=1, nbrTokensPiece do
				...
				checkBoxToken[i]:SetSize(300, 30); 
				checkBoxToken[i]:SetFont(Turbine.UI.Lotro.Font.Verdana16);
			...
			-------------------------------------------------------------------
			posy = posy + 25;
			TitleDisplayer(OptionsWindowTokens, posx, posy, T[ "TokenContent2" ], colorUsedFortexte, colorUsedForLines, 300);
			posy = posy + 25;
			for i=1, nbrTokensPaysage do
				...
				checkBoxTokenPaysage[i]:SetSize(300, 30); 
				checkBoxTokenPaysage[i]:SetFont(Turbine.UI.Lotro.Font.Verdana16);
			...
			-------------------------------------------------------------------
			posy = posy + 25;
			TitleDisplayer(OptionsWindowTokens, posx, posy, T[ "TokenContent3" ], colorUsedFortexte, colorUsedForLines, 300);
			posy = posy + 25;
			for i=1, nbrTokensFestival do
				...
				checkBoxTokenFestival[i]:SetSize(300, 30); 
				checkBoxTokenFestival[i]:SetFont(Turbine.UI.Lotro.Font.Verdana16);
			...
			-------------------------------------------------------------------
			posy = posy + 25;
			TitleDisplayer(OptionsWindowTokens, posx, posy, T[ "TokenContent4" ], colorUsedFortexte, colorUsedForLines, 300);
			posy = posy + 25;
			for i=1, nbrTokensProgression do
				...
				checkBoxTokenProgression[i]:SetSize(300, 30); 
				checkBoxTokenProgression[i]:SetFont(Turbine.UI.Lotro.Font.Verdana16);
			...
			-------------------------------------------------------------------
			posy = posy + 25;
			TitleDisplayer(OptionsWindowTokens, posx, posy, T[ "TokenContent5" ], colorUsedFortexte, colorUsedForLines, 300);
			posy = posy + 25;
			for i=1, nbrTokensAutres do
				...
				checkBoxTokenAutres[i]:SetSize(300, 30); 
				checkBoxTokenAutres[i]:SetFont(Turbine.UI.Lotro.Font.Verdana16);
			...
			-------------------------------------------------------------------
			posy = posy + 25;
			TitleDisplayer(OptionsWindowTokens, posx, posy, T[ "TokenContent6" ], colorUsedFortexte, colorUsedForLines, 300);
			posy = posy + 25;
			for i=1, nbrTokensArtisanats do
				...
				checkBoxTokenArtisanats[i]:SetSize(300, 30); 
				checkBoxTokenArtisanats[i]:SetFont(Turbine.UI.Lotro.Font.Verdana16);
			...
			-------------------------------------------------------------------
			posy = posy + 25;
			TitleDisplayer(OptionsWindowTokens, posx, posy, T[ "TokenContent7" ], colorUsedFortexte, colorUsedForLines, 300);
			posy = posy + 25;
			for i=1, nbrTokensTaxidermiste do
				...
				checkBoxTokenTaxidermiste[i]:SetSize(300, 30); 
				checkBoxTokenTaxidermiste[i]:SetFont(Turbine.UI.Lotro.Font.Verdana16);
			...
			-------------------------------------------------------------------
			posy = posy + 25;
			TitleDisplayer(OptionsWindowTokens, posx, posy, T[ "TokenContent8" ], colorUsedFortexte, colorUsedForLines, 300);
			posy = posy + 25;
			for i=1, nbrTokensInstances do
				...
				checkBoxTokenInstances[i]:SetSize(300, 30); 
				checkBoxTokenInstances[i]:SetFont(Turbine.UI.Lotro.Font.Verdana16);
			...
			-------------------------------------------------------------------
			posy = posy + 25;
			TitleDisplayer(OptionsWindowTokens, posx, posy, T[ "TokenContent9" ], colorUsedFortexte, colorUsedForLines, 300);
			posy = posy + 25;
			for i=1, nbrTokensMonnaie do
				...
				checkBoxTokenMonnaie[i]:SetSize(300, 30); 
				checkBoxTokenMonnaie[i]:SetFont(Turbine.UI.Lotro.Font.Verdana16);
